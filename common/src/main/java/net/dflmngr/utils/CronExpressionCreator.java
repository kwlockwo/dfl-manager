...
public class CronExpressionCreator implements Serializable {
	...
	private static final long serialVersionUID = -3937550815108433539L;
    ...
    /**
     * The date set should be of the format (DD-MM-YYYY for example 25-04-2011)
     * 
     * @param startDate
	...
	public static void main(String[] args) {
        CronExpressionCreator testing = new CronExpressionCreator();
        testing.setTime("12:00 PM");
        testing.setMON(true);
        testing.setStartDate("12-05-2011");
        System.out.println(testing.getCronExpression());
    }
}
